...
//
// Given a log file, print out the locally integrated vehicle position along
// with the timestamp at each position.  Timestamps are given in microseconds
// since 00:00:00 January 1, 1970 UTC.  Positions are given in meters.
